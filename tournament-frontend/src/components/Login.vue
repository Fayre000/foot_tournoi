    ...
    <div class="form-container">
      ...
      <form @submit.prevent="login">
        ...
        <div class="input-container">
          ...
          <input type="text" id="identifier" placeholder="Enter your Identifiant" v-model="username" required />
        </div>
  ...
  methods: {
    async login() {
      try {
        ...
        // Stocker les infos dans le store
        store.setUserData({ userID,username, role });
        ...
        this.errorMessage = "Connexion échouée : " + err.message;
      }
    },
  },
};
